...
CREATE TABLE sentences AS
  SELECT 'The two siblings, '||sib1||' and '||sib2||", have the same size: "||a.size from siblings, size_of_dogs as a, size_of_dogs as b where a.name = sib1 and b.name = sib2 and a.size = b.size;
