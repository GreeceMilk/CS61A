...
def calc_eval(exp):
    ...
    if isinstance(exp, Pair):
        ...
        if operator == 'and': # and expressions
            ...
            return calc_apply(exp.map(calc_eval).first, operands.map(calc_eval)) # UPDATE THIS FOR Q2
...
def eval_and(expressions):
    ...
    if expressions == nil:
        ...
        return eval_and(Pair(calc_eval(expressions.first), expressions.rest))
    elif expressions.rest == nil and expressions.first != nil:
