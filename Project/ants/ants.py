...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while not current_place.is_hive:
            if distance >= self.lower_bound and (self.upper_bound == 0 or self.upper_bound >= distance) and current_place.bees:
...
class FireAnt(Ant):
    ...
    def reduce_health(self, amount):
        ...
        for b in self.place.bees:
            b.reduce_health(reflective_damage)
